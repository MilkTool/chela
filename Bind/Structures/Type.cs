...
namespace Bind.Structures
{
    public class Type : IComparable<Type>
    {
        ...
        public string QualifiedType {
            get
            {
                // HACK: Chela string mashalling.
                if(InFunctionPointer && WrapperType == WrapperTypes.StringParameter/*CurrentType.ToLower().Contains("string")*/)
                    return "sbyte";
        ...
        private bool inFunctionPointer = false;

        /// <summary>
        /// Is this type used in a function pointer?
        /// </summary>
        public bool InFunctionPointer {
            get {
                return inFunctionPointer;
            }
            set {
                inFunctionPointer = value;
            }
        }
